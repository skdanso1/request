...
def main(img_pattern: str, # /media/gaoya/disk/Datasets/DeblurGAN-datasets/blured/test/*.jpg
         mask_pattern: Optional[str] = None,
         weights_path='best_fpn.h5',
         out_dir='submit_cotterpin/',
...
if __name__ == '__main__':
    Fire(main(img_pattern='/media/gaoya/disk/Datasets/DeblurGAN-datasets/blured/test/*.jpg'))
    # Fire(main(img_pattern='/media/disk4T/DeepLearningProjects/DeblurGANv2/terahertz_data/blur/*.png'))
